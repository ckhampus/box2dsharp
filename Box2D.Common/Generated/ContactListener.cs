...
public class ContactListener : IDisposable {
  ...
  private static Type[] swigMethodTypes0 = new Type[] { typeof(IntPtr) };
  private static Type[] swigMethodTypes1 = new Type[] { typeof(IntPtr) };
  private static Type[] swigMethodTypes2 = new Type[] { typeof(IntPtr), typeof(Manifold) };
  private static Type[] swigMethodTypes3 = new Type[] { typeof(IntPtr), typeof(ContactImpulse) };
}
